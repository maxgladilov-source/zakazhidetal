...
export default function Services() {
  return (
    <section id="services" className="relative bg-surface py-20 lg:py-28">
      <div className="mx-auto max-w-6xl px-6">
        ...
        <div className="mt-16 grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
          {SERVICES.items.map((item) => (
            <div
              key={item.key}
              className="group rounded-xl border border-border bg-white p-6 transition-all hover:border-primary/20 hover:shadow-lg"
            >
