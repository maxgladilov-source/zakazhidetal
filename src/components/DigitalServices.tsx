...
export default function DigitalServices() {
  return (
    <section id="digital" className="relative bg-white py-20 lg:py-28">
      <div className="mx-auto max-w-6xl px-6">
        ...
        <div className="mt-16 grid gap-6 sm:grid-cols-2">
          {DIGITAL_SERVICES.items.map((item) => (
            <div
              key={item.key}
              className="group rounded-xl border border-border bg-surface p-6 transition-all hover:border-primary/20 hover:shadow-lg lg:p-8"
            >
